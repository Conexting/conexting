...
<?php
if( $this->wall->enablesms && !$this->wall->isExpired && !$poll->closed ) {
...
$this->widget('PollView',array(
	...
	'options'=>array(
		...
		'allowVoting'=>!$this->wall->isExpired && !$poll->closed,
		'limitVotes'=>(boolean)$poll->limitvotes,
		'limitChoices'=>(boolean)$poll->limitchoices,
	)
));
?>
